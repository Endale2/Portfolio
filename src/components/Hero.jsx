...
const Hero = () => {
  return (
    <section
      ...
      className="min-h-screen bg-slate-900 flex flex-col justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden" // Added relative and overflow-hidden for background gradient
    >
        ...
        >
          <Link
            ...
            className="inline-flex items-center gap-2 font-code text-lg font-medium text-cyan-400 border border-cyan-400 rounded-md px-8 py-3
                         ...
                         hover:bg-cyan-400/10 hover:shadow-lg hover:shadow-cyan-400/20 cursor-pointer" // Added group for icon hover effect
          >
            View My Work
